    ...
    super('francenuage.fr.api.controlplane.v1.InstanceInfo', [
      {
        ...
        options: {
          'validate.rules': { string: { minLen: '1', maxLen: '36', pattern: '^[a-zA-Z0-9_-]+$' } },
        },
      },
      {
        no: 2,
        name: 'status',
        kind: 'enum',
        T: () => ['francenuage.fr.api.controlplane.v1.InstanceStatus', InstanceStatus],
      ...
      },
      {
        ...
        L: 0 /*LongType.BIGINT*/,
        options: { 'validate.rules': { uint64: { lte: '68719476736', gt: '0' } } },
      },
      {
        no: 6,
        ...
        T: 4 /*ScalarType.UINT64*/,
        L: 0 /*LongType.BIGINT*/,
        options: { 'validate.rules': { uint64: { lte: '68719476736', gte: '0' } } },
      },
    ])
  }
}
...
class ListInstancesResponse$Type extends MessageType<ListInstancesResponse> {
  constructor() {
    super('francenuage.fr.api.controlplane.v1.ListInstancesResponse', [
      { no: 1, name: 'success', kind: 'message', oneof: 'result', T: () => InstanceList },
      { no: 2, name: 'problem', kind: 'message', oneof: 'result', T: () => ProblemDetails },
    ])
  }
}
/**
...
class StartInstanceResponse$Type extends MessageType<StartInstanceResponse> {
  constructor() {
    super('francenuage.fr.api.controlplane.v1.StartInstanceResponse', [
      { no: 1, name: 'success', kind: 'message', oneof: 'result', T: () => Empty },
      { no: 2, name: 'problem', kind: 'message', oneof: 'result', T: () => ProblemDetails },
    ])
  }
}
 ...
 */
export const Hypervisor = new ServiceType('francenuage.fr.api.controlplane.v1.Hypervisor', [
