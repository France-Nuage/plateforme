<template>
    ...
    <div class="col-span-3">
      <div>
        ...
        <p class="text-sm text-gray-400">
          Your plan includes a limited amount of usage. If exceeded, you may
          experience restrictions, as you are currently not billed for overages.
  ...
  <div class="mt-16">
    <c-table name="quotas" :data="quotas" :headers="headers">
...
const quotas = ref([
  {
    ...
    totalValue: 5,
    percent: 10,
    service: { name: "Compute Engine API" },
    type: { name: "Quota" },
  },
  {
    name: "Subnetwork ranges per VPC Network",
    currentUsage: 43,
    totalValue: 500,
    percent: 20,
    service: { name: "Compute Engine API" },
