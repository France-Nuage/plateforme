      ...
      <div class="grid grid-cols-12">
        <div class="col-span-6 flex flex-col gap-8">
          ...
          <c-card>
            ...
            <c-card-body>
              <c-alert
                title="Request for organization deletion"
                variant="danger"
              >
                <div class="mb-3">
                  <span class="text-red-300 font-semibold"
                    >Cette action supprimera tous les volumes et données de ce
                    serveur de stockage.</span
                  >
                  Vous ne pouvez supprimer que les Instances démarrées ou
                  arrêtées. Réalisez régulièrement des snapshots pour éviter de
                  perdre des données.
                </div>

                <c-button variant="danger" size="sm"
                  >Request to delete organization</c-button
                >
              </c-alert>
            </c-card-body>
          </c-card>
