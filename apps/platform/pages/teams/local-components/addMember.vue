<template>
  <div>
    <c-button size="sm" @click="isOpen = true"> Accorder l'accès </c-button>
      ...
      <c-modal-body>
        <div class="mb-8">
          ...
          <p class="dark:text-gray-400 text-sm">
            Les comptes principaux sont des utilisateurs, des groupes, des
            domaines ou des comptes de service.
          </p>
          ...
          <div class="mt-4">
            <div
              ...
              :key="person"
              class="dark:text-gray-400 flex items-center px-4 justify-between border-y dark:border-gray-700 py-4"
            >
              <div>{{ person }}</div>
              <div>
                <button
        ...
        <div class="mb-8">
          ...
          <p class="dark:text-gray-400 text-sm">
            Les rôles sont composés d'ensembles d'autorisations et déterminent
            ce que le compte principal peut faire avec cette ressource.
          </p>
