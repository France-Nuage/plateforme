<template>
  <h1 class="text-3xl font-semibold mb-8 dark:text-gray-300">{{ folder.name }}</h1>

  <TabGroup>
    <c-tab-list>
      <c-tab>Général</c-tab>
      <!--      <c-tab>Facturation</c-tab>-->
    </c-tab-list>
    <TabPanels>
      <TabPanel class="w-6/12">
        <general />
      </TabPanel>
      <!--      <TabPanel>-->
      <!--        <billing />-->
...
import General from "~/pages/settings/folders/local-components/general.vue";
