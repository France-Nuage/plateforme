<template>
  ...
  >
    ...
    <button v-if="props.remove" type="button" :class="[`group relative -mr-1 size-3.5 rounded-sm hover:${variantClasses[props.variant].background}/20`]" @click.stop="emit('remove', $event)">
      <span class="sr-only">Remove</span>
      <svg viewBox="0 0 14 14" :class="[`size-3.5 ${variantClasses[props.variant].svg} group-hover:${variantClasses[props.variant].svg}/75`]">
