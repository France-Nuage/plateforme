  ...
  <div>
    ...
    <c-sidebar>
      <c-sidebar-navigation-group>
        <button
          class="text-white text-sm text-start flex items-center gap-2"
          @click="$router.push('/')"
        >
          <Icon
            :name="`solar:backspace-bold-duotone`"
            size="1.3rem"
            style="color: #c1c1c1"
          />
          <span>Retour</span>
      ...
      <c-sidebar-navigation-group title="Profile">
        <c-sidebar-navigation-item
          ...
          :active="route.path === '/profile/preferences'"
        />
        ...
        <c-sidebar-navigation-item
          title="Sécurité"
          icon="lock-keyhole-bold-duotone"
          to="/profile/security"
          :active="route.path === '/profile/security'"
        />
      </c-sidebar-navigation-group>
