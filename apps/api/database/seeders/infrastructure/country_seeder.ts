...
export default class extends BaseSeeder {
  public static async run() {
    ...
    //     name: 'Espagne',
    //     phoneIndicator: '+34',
    //     phoneRegex: '^\\+34\\s?(6|7)\\d{1}(\\s?\\d{2}){4}$',
    //     postalCodeRegex: '^\\d{5}$',
    //     // "x_language_code": "es",
    //     latitude: 40.463667,
    //     longitude: -3.74922,
    ...
    //     name: 'Suisse',
    //     phoneIndicator: '+41',
    //     phoneRegex: '^\\+41\\s?\\d{2}\\s?\\d{3}\\s?\\d{2}\\s?\\d{2}$',
    //     postalCodeRegex: '^\\d{4}$',
    //     // "x_language_code": "de,fr,it",
    //     latitude: 46.818188,
    //     longitude: 8.227512,
    //     flagSvg:
