...
class KubernetesClusterProto$Type extends MessageType<KubernetesClusterProto> {
    constructor() {
        super("francenuage.fr.v1.kubernetes.KubernetesClusterProto", [
            ...
            { no: 4, name: "api_server_url", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 5, name: "ca_fingerprint", kind: "scalar", opt: true, T: 9 /*ScalarType.STRING*/ },
            { no: 10, name: "kubernetes_version", kind: "scalar", opt: true, T: 9 /*ScalarType.STRING*/ },
            { no: 11, name: "platform", kind: "scalar", opt: true, T: 9 /*ScalarType.STRING*/ },
...
class ListClustersResponse$Type extends MessageType<ListClustersResponse> {
    constructor() {
        super("francenuage.fr.v1.kubernetes.ListClustersResponse", [
            { no: 1, name: "clusters", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => KubernetesClusterProto }
        ]);
    }
}
/**
...
class GetClusterResponse$Type extends MessageType<GetClusterResponse> {
    constructor() {
        super("francenuage.fr.v1.kubernetes.GetClusterResponse", [
            { no: 1, name: "cluster", kind: "message", T: () => KubernetesClusterProto }
        ]);
    }
}
/**
...
class UpdateClusterRequest$Type extends MessageType<UpdateClusterRequest> {
    constructor() {
        super("francenuage.fr.v1.kubernetes.UpdateClusterRequest", [
            ...
            { no: 2, name: "name", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 3, name: "description", kind: "scalar", opt: true, T: 9 /*ScalarType.STRING*/ },
            { no: 4, name: "kubeconfig", kind: "scalar", opt: true, T: 9 /*ScalarType.STRING*/ }
        ]);
    }
}
/**
 ...
 */
export const KubernetesClusters = new ServiceType("francenuage.fr.v1.kubernetes.KubernetesClusters", [
