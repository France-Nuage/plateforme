...
export interface IOrganizationsClient {
     ...
     */
    list(input: ListOrganizationsRequest, options?: RpcOptions): UnaryCall<ListOrganizationsRequest, ListOrganizationsResponse>;
    /**
     * @generated from protobuf rpc: Create
     */
    create(input: CreateOrganizationRequest, options?: RpcOptions): UnaryCall<CreateOrganizationRequest, CreateOrganizationResponse>;
}
/**
 * @generated from protobuf service francenuage.fr.resourcemanager.v1.Organizations
 */
...
export interface IProjectsClient {
     ...
     * @generated from protobuf rpc: List
     */
    list(input: ListProjectsRequest, options?: RpcOptions): UnaryCall<ListProjectsRequest, ListProjectsResponse>;
    /**
     * @generated from protobuf rpc: Create
     */
