...
export interface IKubernetesClustersClient {
  ...
  listLabels(
    ...
    options?: RpcOptions,
  ): UnaryCall<ListLabelsRequest, ListLabelsResponse>;
  /**
  ...
  createLabel(
    ...
    options?: RpcOptions,
  ): UnaryCall<CreateLabelRequest, CreateLabelResponse>;
  /**
  ...
  deleteLabel(
    ...
    options?: RpcOptions,
  ): UnaryCall<DeleteLabelRequest, DeleteLabelResponse>;
  /**
   ...
   */
  attachClusterLabel(
    input: AttachClusterLabelRequest,
    options?: RpcOptions,
  ): UnaryCall<AttachClusterLabelRequest, AttachClusterLabelResponse>;
  /**
   ...
   */
  detachClusterLabel(
    input: DetachClusterLabelRequest,
    options?: RpcOptions,
  ): UnaryCall<DetachClusterLabelRequest, DetachClusterLabelResponse>;
  /**
  ...
  listServicesReferencingLabel(
    input: ListServicesReferencingLabelRequest,
    options?: RpcOptions,
  ): UnaryCall<
  ...
  implements IKubernetesClustersClient, ServiceInfo
{
  ...
  listLabels(
    ...
    const method = this.methods[5],
      opt = this._transport.mergeOptions(options);
    return stackIntercept<ListLabelsRequest, ListLabelsResponse>(
      'unary',
      this._transport,
      method,
      opt,
  ...
  createLabel(
    ...
    const method = this.methods[6],
      opt = this._transport.mergeOptions(options);
    return stackIntercept<CreateLabelRequest, CreateLabelResponse>(
      'unary',
      this._transport,
      method,
      opt,
  ...
  deleteLabel(
    ...
    const method = this.methods[7],
      opt = this._transport.mergeOptions(options);
    return stackIntercept<DeleteLabelRequest, DeleteLabelResponse>(
      'unary',
      this._transport,
      method,
      opt,
