...
class ListHypervisorsResponse$Type extends MessageType<ListHypervisorsResponse> {
    constructor() {
        super("francenuage.fr.v1.compute.ListHypervisorsResponse", [
            { no: 1, name: "hypervisors", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Hypervisor }
        ]);
    }
}
/**
...
class RegisterHypervisorRequest$Type extends MessageType<RegisterHypervisorRequest> {
    constructor() {
        super("francenuage.fr.v1.compute.RegisterHypervisorRequest", [
            ...
            { no: 2, name: "storage_name", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
...
class Instance$Type extends MessageType<Instance> {
    constructor() {
        super("francenuage.fr.v1.compute.Instance", [
            { no: 1, name: "id", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "validate.rules": { string: { minLen: "1", maxLen: "36", pattern: "^[a-zA-Z0-9_-]+$" } } } },
            { no: 2, name: "status", kind: "enum", T: () => ["francenuage.fr.v1.compute.InstanceStatus", InstanceStatus], options: { "validate.rules": { enum: { definedOnly: true } } } },
            ...
            { no: 7, name: "max_disk_bytes", kind: "scalar", T: 4 /*ScalarType.UINT64*/, L: 0 /*LongType.BIGINT*/, options: { "validate.rules": { uint64: { lte: "109951162777600", gt: "0" } } } },
            { no: 8, name: "disk_usage_bytes", kind: "scalar", T: 4 /*ScalarType.UINT64*/, L: 0 /*LongType.BIGINT*/, options: { "validate.rules": { uint64: { lte: "109951162777600", gte: "0" } } } },
            { no: 9, name: "name", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 10, name: "ip_v4", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "validate.rules": { string: { pattern: "^((25[0-5]|(2[0-4]|1\\d|[1-9]|)\\d)\\.?\\b){4}$" } } } },
            { no: 100, name: "hypervisor_id", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "validate.rules": { string: { minLen: "1", maxLen: "36", pattern: "^[a-zA-Z0-9_-]+$" } } } },
            { no: 101, name: "project_id", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "validate.rules": { string: { minLen: "1", maxLen: "36", pattern: "^[a-zA-Z0-9_-]+$" } } } },
            { no: 102, name: "zero_trust_network_id", kind: "scalar", opt: true, T: 9 /*ScalarType.STRING*/, options: { "validate.rules": { string: { minLen: "1", maxLen: "36", pattern: "^[a-zA-Z0-9_-]+$" } } } },
...
class ListInstancesResponse$Type extends MessageType<ListInstancesResponse> {
    constructor() {
        super("francenuage.fr.v1.compute.ListInstancesResponse", [
            { no: 1, name: "instances", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Instance }
        ]);
    }
}
/**
...
class CloneInstanceRequest$Type extends MessageType<CloneInstanceRequest> {
    constructor() {
        super("francenuage.fr.v1.compute.CloneInstanceRequest", [
            { no: 1, name: "id", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "validate.rules": { string: { minLen: "1", maxLen: "36", pattern: "^[a-zA-Z0-9_-]+$" } } } },
            { no: 2, name: "name", kind: "scalar", opt: true, T: 9 /*ScalarType.STRING*/, options: { "validate.rules": { string: { minLen: "1", maxLen: "128", pattern: "^[a-zA-Z0-9_-]+$" } } } }
        ]);
    }
}
/**
...
class CreateInstanceRequest$Type extends MessageType<CreateInstanceRequest> {
    constructor() {
        super("francenuage.fr.v1.compute.CreateInstanceRequest", [
            ...
            { no: 8, name: "disk_bytes", kind: "scalar", T: 4 /*ScalarType.UINT64*/, L: 0 /*LongType.BIGINT*/, options: { "validate.rules": { uint64: { lte: "536870912000", gt: "10737418240" } } } },
            ...
            { no: 7, name: "project_id", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "validate.rules": { string: { minLen: "1", maxLen: "36", pattern: "^[a-zA-Z0-9_-]+$" } } } }
        ]);
    }
}
/**
...
class UpdateInstanceRequest$Type extends MessageType<UpdateInstanceRequest> {
    constructor() {
        super("francenuage.fr.v1.compute.UpdateInstanceRequest", [
            { no: 1, name: "id", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "validate.rules": { string: { minLen: "1", maxLen: "36", pattern: "^[a-zA-Z0-9_-]+$" } } } },
            { no: 2, name: "name", kind: "scalar", opt: true, T: 9 /*ScalarType.STRING*/, options: { "validate.rules": { string: { minLen: "1", maxLen: "128", pattern: "^[a-zA-Z0-9_-]+$" } } } },
            { no: 3, name: "project_id", kind: "scalar", opt: true, T: 9 /*ScalarType.STRING*/, options: { "validate.rules": { string: { minLen: "1", maxLen: "36", pattern: "^[a-zA-Z0-9_-]+$" } } } }
        ]);
    }
}
/**
...
class ListZonesResponse$Type extends MessageType<ListZonesResponse> {
    constructor() {
        super("francenuage.fr.v1.compute.ListZonesResponse", [
            { no: 1, name: "zones", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Zone }
        ]);
    }
}
/**
 ...
 */
export const Hypervisors = new ServiceType("francenuage.fr.v1.compute.Hypervisors", [
    { name: "List", options: {}, I: ListHypervisorsRequest, O: ListHypervisorsResponse },
    { name: "Register", options: {}, I: RegisterHypervisorRequest, O: RegisterHypervisorResponse },
    { name: "Detach", options: {}, I: DetachHypervisorRequest, O: DetachHypervisorResponse }
]);
/**
 * @generated ServiceType for protobuf service francenuage.fr.v1.compute.Instances
 */
export const Instances = new ServiceType("francenuage.fr.v1.compute.Instances", [
    { name: "List", options: {}, I: ListInstancesRequest, O: ListInstancesResponse },
    { name: "Clone", options: {}, I: CloneInstanceRequest, O: Instance },
    { name: "Create", options: {}, I: CreateInstanceRequest, O: CreateInstanceResponse },
    { name: "Delete", options: {}, I: DeleteInstanceRequest, O: DeleteInstanceResponse },
    { name: "Start", options: {}, I: StartInstanceRequest, O: StartInstanceResponse },
    { name: "Stop", options: {}, I: StopInstanceRequest, O: StopInstanceResponse },
    { name: "Update", options: {}, I: UpdateInstanceRequest, O: UpdateInstanceResponse }
]);
/**
