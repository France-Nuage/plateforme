...
export interface IResourcesClient {
     ...
     *
     * @generated from protobuf rpc: ListOrganizations(francenuage.fr.api.controlplane.v1.resources.ListOrganizationsRequest) returns (francenuage.fr.api.controlplane.v1.resources.ListOrganizationsResponse);
     */
     ...
     *
     * @generated from protobuf rpc: CreateOrganization(francenuage.fr.api.controlplane.v1.resources.CreateOrganizationRequest) returns (francenuage.fr.api.controlplane.v1.resources.CreateOrganizationResponse);
     */
     ...
     *
     * @generated from protobuf rpc: ListProjects(francenuage.fr.api.controlplane.v1.resources.ListProjectsRequest) returns (francenuage.fr.api.controlplane.v1.resources.ListProjectsResponse);
     */
     ...
     *
     * @generated from protobuf rpc: CreateProject(francenuage.fr.api.controlplane.v1.resources.CreateProjectRequest) returns (francenuage.fr.api.controlplane.v1.resources.CreateProjectResponse);
     */
