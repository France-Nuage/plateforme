...
const guestRoutes = ['/login', `/auth/redirect/${process.env.NEXT_PUBLIC_OIDC_PROVIDER_NAME}`];

export const AuthenticationGuard: FunctionComponent<AuthenticationGuardProps> = ({ children, router }) => {
