...
import sty from "./PlasmicModal.module.css"; // plasmic-import: tYFejTQb0c1A/css
    ...
    <BaseDialogTrigger
      ...
      dialog={
        <BaseModal
          ...
          modalOverlayClass={classNames({ [sty["pcls_2cAuIX-ZZVx2"]]: true })}
              ...
              {renderPlasmicSlot({
                defaultContents: (
                  <Stack__
                    as={"div"}
                    hasGap={true}
                    className={classNames(projectcss.all, sty.freeBox___3QKvt)}
                  >
                    <div
                      className={classNames(
                        projectcss.all,
