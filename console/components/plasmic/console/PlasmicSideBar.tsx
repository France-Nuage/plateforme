...
import sty from "./PlasmicSideBar.module.css"; // plasmic-import: WgBKdGHdVFBy/css

import SearchIcon from "./icons/PlasmicIcon__Search"; // plasmic-import: TueurUSDtevy/icon
import CircleIcon from "./icons/PlasmicIcon__Circle"; // plasmic-import: INMXktOfIWiD/icon
import BellIcon from "./icons/PlasmicIcon__Bell"; // plasmic-import: MqRFF7vxUCiv/icon
import HomeIcon from "./icons/PlasmicIcon__Home"; // plasmic-import: LPIiQLy4lvIE/icon
import UserIcon from "./icons/PlasmicIcon__User"; // plasmic-import: HOWLf5KCV6xi/icon
import FactureIcon from "./icons/PlasmicIcon__Facture"; // plasmic-import: q8GlA5e81ML_/icon
import SettingsIcon from "./icons/PlasmicIcon__Settings"; // plasmic-import: 0zFkNWu9LQOC/icon
import DevSquareIcon from "./icons/PlasmicIcon__DevSquare"; // plasmic-import: CnqcBI0upv9T/icon
import Icon4Icon from "./icons/PlasmicIcon__Icon4"; // plasmic-import: wy92u1XfZPXm/icon
import Icon11Icon from "./icons/PlasmicIcon__Icon11"; // plasmic-import: M5Yt0pb7IRm_/icon
import Icon10Icon from "./icons/PlasmicIcon__Icon10"; // plasmic-import: tmJQKBQDJEoe/icon
