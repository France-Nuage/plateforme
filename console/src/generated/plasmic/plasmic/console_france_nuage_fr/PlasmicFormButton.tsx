...
import sty from './PlasmicFormButton.module.css';
...
// plasmic-import: BPkDJbnqSOZ0/css
...
export type PlasmicFormButton__VariantMembers = {
...
export type PlasmicFormButton__VariantsArgs = {
...
type VariantPropType = keyof PlasmicFormButton__VariantsArgs;
export const PlasmicFormButton__VariantProps = new Array<VariantPropType>(
  'color',
  'type',
  'size',
  'iconStart',
...
export type PlasmicFormButton__ArgsType = {
  disabled?: boolean;
  submitsForm?: boolean;
  resetsForm?: boolean;
  ariaLabel?: string;
...
type ArgPropType = keyof PlasmicFormButton__ArgsType;
export const PlasmicFormButton__ArgProps = new Array<ArgPropType>(
  'disabled',
  'submitsForm',
  'resetsForm',
  'ariaLabel',
...
export type PlasmicFormButton__OverridesType = {
...
export interface DefaultFormButtonProps {
  disabled?: boolean;
  submitsForm?: boolean;
  resetsForm?: boolean;
  ariaLabel?: string;
...
function PlasmicFormButton__RenderFunc(props: {
  variants: PlasmicFormButton__VariantsArgs;
  args: PlasmicFormButton__ArgsType;
  overrides: PlasmicFormButton__OverridesType;
  forNode?: string;
}) {
  ...
  return (
    ...
    >
      ...
      <Stack__
        as={'div'}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox___5UFrc, {
          [sty.freeBoxcolor_neutral___5UFrcVwP]: hasVariant(
            $state,
            'color',
            'neutral',
          ),
          ...
          [sty.freeBoxsize_extraLarge___5UFrCqw8T]: hasVariant(
            $state,
            'size',
            'extraLarge',
          ),
          [sty.freeBoxsize_extraSmall___5UFrcfdxvt]: hasVariant(
            $state,
            'size',
            'extraSmall',
          ),
          [sty.freeBoxsize_large___5UFrcBc8JA]: hasVariant(
            $state,
            'size',
            'large',
          ),
          [sty.freeBoxsize_small___5UFrc98KxI]: hasVariant(
            $state,
            'size',
            'small',
          ),
          [sty.freeBoxtype_bordered___5UFrCyk5I3]: hasVariant(
            $state,
            'type',
            'bordered',
          ),
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__zepuG, {
            [sty.freeBoxcolor_neutral__zepuGVwP]: hasVariant(
              $state,
              'color',
              'neutral',
            ),
            [sty.freeBoxcolor_neutral_type_soft__zepuGVwP7FFl]:
              hasVariant($state, 'color', 'neutral') &&
              hasVariant($state, 'type', 'soft'),
            [sty.freeBoxiconStart__zepuGjCw1G]: hasVariant(
              $state,
              'iconStart',
              'iconStart',
            ),
            [sty.freeBoxsize_extraLarge__zepuGqw8T]: hasVariant(
              $state,
              'size',
              'extraLarge',
            ),
            [sty.freeBoxsize_large__zepuGBc8JA]: hasVariant(
              $state,
              'size',
              'large',
            ),
            [sty.freeBoxsize_small__zepuG98KxI]: hasVariant(
              $state,
              'size',
              'small',
            ),
            [sty.freeBoxtype_bordered__zepuGyk5I3]: hasVariant(
              $state,
              'type',
              'bordered',
            ),
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__fNxkP)}
                role={'img'}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__uzG6A, {
            [sty.freeBoxiconEnd__uzG6AaaJ1T]: hasVariant(
              $state,
              'iconEnd',
              'iconEnd',
            ),
            [sty.freeBoxsize_extraLarge__uzG6Aqw8T]: hasVariant(
              $state,
              'size',
              'extraLarge',
            ),
            [sty.freeBoxsize_large__uzG6ABc8JA]: hasVariant(
              $state,
              'size',
              'large',
            ),
            [sty.freeBoxsize_small__uzG6A98KxI]: hasVariant(
              $state,
              'size',
              'small',
            ),
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChevronDownIcon
                className={classNames(projectcss.all, sty.svg___7Jer)}
                role={'img'}
              />
            ),
...
type NodeOverridesType<T extends NodeNameType> = Pick<
  PlasmicFormButton__OverridesType,
  DescendantsType<T>
>;
type NodeComponentProps<T extends NodeNameType> =
  ...
  } & Omit<PlasmicFormButton__VariantsArgs, ReservedPropsType> & // Specify variants directly as props
    // Specify args directly as props
    Omit<PlasmicFormButton__ArgsType, ReservedPropsType> &
...
function makeNodeComponent<NodeName extends NodeNameType>(nodeName: NodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicFormButton__ArgProps,
          internalVariantPropNames: PlasmicFormButton__VariantProps,
        }),
      [props, nodeName],
    );
    return PlasmicFormButton__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName,
  ...
  if (nodeName === 'root') {
    func.displayName = 'PlasmicFormButton';
  } else {
    func.displayName = `PlasmicFormButton.${nodeName}`;
  }
  return func;
}

export const PlasmicFormButton = Object.assign(
  // Top-level PlasmicFormButton renders the root element
  makeNodeComponent('root'),
  {
    ...
    // Metadata about props expected for PlasmicFormButton
    internalVariantProps: PlasmicFormButton__VariantProps,
    internalArgProps: PlasmicFormButton__ArgProps,
  },
);

export default PlasmicFormButton;
/* prettier-ignore-end */
