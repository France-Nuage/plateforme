    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* repeated int64 in */ 6:
          ...
          else message.in.push(reader.int64().toBigInt());
          break;
        case /* repeated int64 not_in */ 7:
          if (wireType === WireType.LengthDelimited)
            for (let e = reader.int32() + reader.pos; reader.pos < e; )
              message.notIn.push(reader.int64().toBigInt());
          else message.notIn.push(reader.int64().toBigInt());
          break;
        case /* optional bool ignore_empty */ 8:
          message.ignoreEmpty = reader.bool();
          break;
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* repeated uint64 in */ 6:
          ...
          else message.in.push(reader.uint64().toBigInt());
          break;
        case /* repeated uint64 not_in */ 7:
          if (wireType === WireType.LengthDelimited)
            for (let e = reader.int32() + reader.pos; reader.pos < e; )
              message.notIn.push(reader.uint64().toBigInt());
          else message.notIn.push(reader.uint64().toBigInt());
          break;
        case /* optional bool ignore_empty */ 8:
          message.ignoreEmpty = reader.bool();
          break;
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* repeated sint64 in */ 6:
          ...
          else message.in.push(reader.sint64().toBigInt());
          break;
        case /* repeated sint64 not_in */ 7:
          if (wireType === WireType.LengthDelimited)
            for (let e = reader.int32() + reader.pos; reader.pos < e; )
              message.notIn.push(reader.sint64().toBigInt());
          else message.notIn.push(reader.sint64().toBigInt());
          break;
        case /* optional bool ignore_empty */ 8:
          message.ignoreEmpty = reader.bool();
          break;
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* repeated fixed64 in */ 6:
          ...
          else message.in.push(reader.fixed64().toBigInt());
          break;
        case /* repeated fixed64 not_in */ 7:
          if (wireType === WireType.LengthDelimited)
            for (let e = reader.int32() + reader.pos; reader.pos < e; )
              message.notIn.push(reader.fixed64().toBigInt());
          else message.notIn.push(reader.fixed64().toBigInt());
          break;
        case /* optional bool ignore_empty */ 8:
          message.ignoreEmpty = reader.bool();
          break;
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* repeated sfixed64 in */ 6:
          ...
          else message.in.push(reader.sfixed64().toBigInt());
          break;
        case /* repeated sfixed64 not_in */ 7:
          if (wireType === WireType.LengthDelimited)
            for (let e = reader.int32() + reader.pos; reader.pos < e; )
              message.notIn.push(reader.sfixed64().toBigInt());
          else message.notIn.push(reader.sfixed64().toBigInt());
          break;
        case /* optional bool ignore_empty */ 8:
          message.ignoreEmpty = reader.bool();
          break;
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* optional google.protobuf.Duration lt */ 3:
          message.lt = Duration.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.lt,
        ...
        case /* optional google.protobuf.Duration lte */ 4:
          message.lte = Duration.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.lte,
        ...
        case /* optional google.protobuf.Duration gt */ 5:
          message.gt = Duration.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.gt,
        ...
        case /* optional google.protobuf.Duration gte */ 6:
          message.gte = Duration.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.gte,
        ...
        case /* repeated google.protobuf.Duration in */ 7:
          message.in.push(
            Duration.internalBinaryRead(reader, reader.uint32(), options),
          );
          break;
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* optional google.protobuf.Timestamp lt */ 3:
          message.lt = Timestamp.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.lt,
        ...
        case /* optional google.protobuf.Timestamp lte */ 4:
          message.lte = Timestamp.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.lte,
        ...
        case /* optional google.protobuf.Timestamp gt */ 5:
          message.gt = Timestamp.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.gt,
        ...
        case /* optional google.protobuf.Timestamp gte */ 6:
          message.gte = Timestamp.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.gte,
