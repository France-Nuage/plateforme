...
class Instance$Type extends MessageType<Instance> {
    constructor() {
        super("francenuage.fr.api.controlplane.v1.instances.Instance", [
            { no: 1, name: "id", kind: "scalar", T: 9 /*ScalarType.STRING*/, options: { "validate.rules": { string: { minLen: "1", maxLen: "36", pattern: "^[a-zA-Z0-9_-]+$" } } } },
            { no: 2, name: "status", kind: "enum", T: () => ["francenuage.fr.api.controlplane.v1.instances.InstanceStatus", InstanceStatus], options: { "validate.rules": { enum: { definedOnly: true } } } },
...
class ListInstancesRequest$Type extends MessageType<ListInstancesRequest> {
    constructor() {
        super("francenuage.fr.api.controlplane.v1.instances.ListInstancesRequest", []);
    }
}
/**
...
class ListInstancesResponse$Type extends MessageType<ListInstancesResponse> {
    constructor() {
        super("francenuage.fr.api.controlplane.v1.instances.ListInstancesResponse", [
...
class StartInstanceResponse$Type extends MessageType<StartInstanceResponse> {
    constructor() {
        super("francenuage.fr.api.controlplane.v1.instances.StartInstanceResponse", []);
    }
}
/**
...
class StopInstanceResponse$Type extends MessageType<StopInstanceResponse> {
    constructor() {
        super("francenuage.fr.api.controlplane.v1.instances.StopInstanceResponse", []);
    }
}
/**
