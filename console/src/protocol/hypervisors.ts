...
/**
 * RegisterHypervisorRequest is an empty message for registering an hypervisor.
 *
...
class ListHypervisorsRequest$Type extends MessageType<ListHypervisorsRequest> {
    constructor() {
        super("francenuage.fr.api.controlplane.v1.hypervisors.ListHypervisorsRequest", []);
    }
}
/**
...
class ListHypervisorsResponse$Type extends MessageType<ListHypervisorsResponse> {
    constructor() {
        super("francenuage.fr.api.controlplane.v1.hypervisors.ListHypervisorsResponse", [
            { no: 1, name: "hypervisors", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => Hypervisor }
        ]);
    }
}
/**
...
class RegisterHypervisorResponse$Type extends MessageType<RegisterHypervisorResponse> {
    constructor() {
        super("francenuage.fr.api.controlplane.v1.hypervisors.RegisterHypervisorResponse", []);
    }
}
/**
