...
impl From<Resource> for proto::v0::InstanceInfo {
    fn from(value: Resource) -> Self {
        proto::v0::InstanceInfo {
...
mod tests {
    ...
    async fn test_cluster_resource_list() {
        ...
        let result = cluster_resource_list(&server.url(), &client).await;
