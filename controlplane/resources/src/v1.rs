...
impl From<crate::organizations::Organization> for Organization {
    fn from(org: crate::organizations::Organization) -> Self {
        Self {
            id: org.id.to_string(),
            name: org.name,
...
impl From<crate::projects::Project> for Project {
    fn from(project: crate::projects::Project) -> Self {
        Self {
