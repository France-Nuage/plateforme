use hypervisor_connector_proxmox::mock::{
    ...
    WithVMCloneMock, WithVMCreateMock, WithVMStatusStartMock, WithVMStatusStopMock,
};
use hypervisors::{
    Hypervisor,
    v1::{
...
use instances::{
    Instance,
    v1::{
        CloneInstanceRequest, CreateInstanceRequest, CreateInstanceResponse, ListInstancesRequest,
        StartInstanceRequest, StopInstanceRequest, instances_client::InstancesClient,
    },
};
