...
pub mod mock {
    ...
    pub trait WithUpdateUserMock {
        fn with_update_user(self) -> Self;
    }

    impl WithUpdateUserMock for MockServer {
        fn with_update_user(mut self) -> Self {
            let mock = self
                .server
                .mock(
                    "PATCH",
...
mod tests {
    use super::mock::WithUpdateUserMock;
    use super::*;
    use mock_server::MockServer;
    ...
    async fn test_update_user() {
        ...
        let server = MockServer::new().await.with_update_user();
